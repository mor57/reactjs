...
class Travel extends Component {
  ...
  componentWillMount() {
    ...
    this.loadTablelist(this.handleTablelist);
  }
  componentDidMount() {
  }
  constructor(props) {
    ...
    this.loadTablelist = () => {
      this.setState({
        Tablelist: [
          { key: 1, CompanyTitle: 'البرز', TedadShoab: '5', NerkhPayeStr: '10200', NerKhKolPlusArzashaafzoodeStr: '20500' },
          { key: 2, CompanyTitle: 'آسیا', TedadShoab: '5', NerkhPayeStr: '10200', NerKhKolPlusArzashaafzoodeStr: '20500' },
        ]
      });
    }
