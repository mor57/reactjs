...
// import {countries} from './components/countrycombo';

// const axiosInstance = axios.create({
//   baseURL: 'http://portal.bimetehran.com/',
//   timeout: 2000,
...
// fetch("http://localhost:47002/Home/Country_List", { CountryStatus: 1 })
//       .then((response) => {
...
//         // this.setState({ options: [{value: '', display: '(Select your favourite team)'}].concat(teamsFromApi) });
//         // console.log(teamsFromApi);
//       }).catch(error => {
//         console.log(error);
//       });
  return axios.post('http://localhost:47002/Home/Country_List', { CountryStatus: 1 })
...
class Travel extends Component {
   componentWillMount() {
    ...
    //   ]
    // }
    // axios.get('http://portal.bimetehran.com//Home/Country_List')
    // axios.post('http://localhost:47102/Home/Country_List', { CountryStatus:1 })
    //   .then(res => {
    ...
    //   })
    // axios({
    //   url: 'http://portal.bimetehran.com//Home/Country_List',
    //   method: 'post',
    //   data: {
    //     firstName: 'Fred',
    //   }
  ...
  constructor(props) {
    super(props);
    //const options=loadOptions(null)
    this.state = {
      // selected_value: "one",
      // tags: [],
      // async_test: [],
  ...
  render() {
    ...
    //   axios.defaults.baseURL = 'http://localhost:47102/';
    //   axios.defaults.headers.common['Accept'] = 'application/json';
    //   axios.defaults.headers.common['Content-Type'] = 'application/json';

    //   return axios.post('Home/Country_List', { CountryStatus: 1 })
    //     .then(function (response) {
    //       let options = response.data.map(item => ({ value: item.CountryID, label: item.CountryTitle }));
    //       return { options };
    //     })
                ...
                <div className="form-group">
                  ...
                  <div className="row-fluid">
                    <div className="radio-success">
                      <input id="rbtnTravelTo1" name="rbtnTravelTo" type="radio" value="1" checked="checked" readOnly />
                      <label htmlFor="rbtnTravelTo1">یک کشور </label>
                      <input id="rbtnTravelTo0" name="rbtnTravelTo" type="radio" value="0" />
              ...
              <div className="col-md-2">
                <div className="form-group">
                  ...
                  <div className="controls">
                    <select name="form3Gender" id="cmbCountryID" className="select2 form-control" aria-required="true" aria-invalid="false" aria-describedby="form3Gender-error"></select>
                  </div>
                </div>
              </div>
              <div className="col-md-3">
                <div className="form-group">
                  ...
                  <div className="controls">
                    <select name="form3Gender" id="cmbTravelDurationID" className="select2 form-control" aria-required="true" aria-invalid="false" aria-describedby="form3Gender-error"></select>
                  </div>
                </div>
              </div>
              <div className="col-md-2">
                <div className="form-group">
                  ...
                  <div className="controls">
                    <select name="form3Gender" id="cmbTravelAgeID" className="select2 form-control" aria-required="true" aria-invalid="false" aria-describedby="form3Gender-error"></select>
                  </div>
                </div>
              </div>
              <div className="col-md-2 form-group">
                <label className="form-label" style={{ visibility: 'hidden' }}>استعلام</label>
                <button type="button" className="btn btn-warning" id="btnSearchTarefeh">جستجو قیمت</button>
              </div>
            </div>
          </div>
          <div id="CompanyBime">
